...
app.kubernetes.io/name: {{ include "beekeeper.name" . }}
...
*/}}
{{- define "beekeeper.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "beekeeper.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
